...
if ( !isset( $bejo_option ) && file_exists( dirname( __FILE__ ) . '/functions/theme-functions/wp-options.php' ) ) {
...
function blog_aink_required_plugins() {
	...
	$string = array(
		'page_title' => __( 'Install Required Plugins', 'asli_bejo' ),
		'menu_title' => __( 'Install Plugins', 'asli_bejo' ),
		'installing' => __( 'Installing Plugin: %s', 'asli_bejo' ),
		'oops' => __( 'Something went wrong with the plugin API.', 'asli_bejo' ),
		...
		'return' => __( 'Return to Required Plugins Installer', 'asli_bejo' ),
		'plugin_activated' => __( 'Plugin activated successfully.', 'asli_bejo' ),
		'complete' => __( 'All plugins installed and activated successfully. %s', 'asli_bejo' ),
		'nag_type' => 'updated'
	);

	$theme_text_domain = 'asli_bejo';
